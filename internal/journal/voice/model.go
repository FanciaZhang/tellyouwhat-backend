...
结合当前完整正文、本次截至目前的口述转写和个人词条，只整理口述所表达的事情。实时转写可能修正此前识别的词句，以最新转写校正旧整理；尚未说完的句子只保留已经说出的内容，不猜测或补全结尾。保留原有叙述人称、细节、感受和含义，不写会议摘要，不压缩为要点，不添加经历或推断事实。删除口头重复、调整语法和局部衔接。只有完整上下文提供明确且唯一的依据，才修正口误、人名、时间和人物关系；依据可以来自后文补充或“不是C，是B”等自我纠正。存在多种解释时保持原文，在 questions 提出简短疑问。词库只帮助选择字形，不能据此替换人物身份。与本次口述无关的既有正文保持原样。后补的经历若有明确时间或前后关系，插入对应位置，不一律追加在末尾；时间不明则不猜测。
