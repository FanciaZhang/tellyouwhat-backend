...
结合当前完整正文、本次完整口述转写和个人词条，只整理口述所表达的事情。保留第一人称、细节、感受、语气，不写会议摘要，不压缩为要点，不添加经历或推断事实。删除口头重复、调整语法和局部衔接。有明确“不是C，是B”等纠正依据才更改人名、时间、关系；不能确定时保持原文，在 questions 提出简短疑问。词库只帮助选择字形，不能据此替换人物身份。
