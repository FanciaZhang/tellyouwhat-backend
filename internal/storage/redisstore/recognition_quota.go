...
func NewRecognitionQuotaStore(client *redis.Client) *RecognitionQuotaStore {
	return &RecognitionQuotaStore{client: client}
}
...
func (store *RecognitionQuotaStore) Reserve(
	...
	values, err := reserveRecognitionSessionScript.Run(ctx, store.client, []string{recognitionWindowKey(request.DeviceID)},
...
func (store *RecognitionQuotaStore) Complete(
	...
	values, err := completeRecognitionSessionScript.Run(ctx, store.client, []string{recognitionWindowKey(deviceID)},
...
func (store *RecognitionQuotaStore) Cancel(ctx context.Context, deviceID, sessionID string, now time.Time) error {
	...
	return cancelRecognitionSessionScript.Run(ctx, store.client, []string{recognitionWindowKey(deviceID)},
...
func (store *RecognitionQuotaStore) Snapshot(
	...
	values, err := snapshotRecognitionSessionsScript.Run(ctx, store.client, []string{recognitionWindowKey(deviceID)},
